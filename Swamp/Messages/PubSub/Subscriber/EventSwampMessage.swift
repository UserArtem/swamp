...
class EventSwampMessage: SwampMessage {
    ...
    init(subscription: UInt64, publication: UInt64, details: [String: AnyObject], args: [AnyObject]?=nil, kwargs: [String: AnyObject]?=nil) {
    ...
    required init(payload: [Any]) {
        self.subscription = payload[0] as! UInt64
